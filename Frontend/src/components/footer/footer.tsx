export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-950/90 mt-10 border-t border-gray-300">
      <div className="w-full max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            ...
            <p className="text-sm font-light">
              ...
              amet metus non elit malesuada vestibulum.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-300 dark:border-gray-700 mt-4 pt-4 flex justify-between items-center">
          <p className="text-sm font-light">
            © 2022 Mr. Food. Todos os direitos reservados.
          </p>
          <div className="flex gap-4">
            <a href="#" className="hover:underline">
              Termos de Uso
