...
const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  const [companyToken, setCompanyToken] = useState<string | null>(localStorage.getItem('companyToken'));
  ...
  return (
    <AuthContext.Provider value={{clientToken, companyToken, logoutClient, logoutCompany, setClientToken, setCompanyToken, updateCompanyToken}}>
      {children}
